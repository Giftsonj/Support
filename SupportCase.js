...
class SupportCase extends Component {
    ...
    textDesc(evt) {
        ...
        // let letMainCategory1 = this.state.textAreaContent;
        // let letText = letMainCategory;
        // alert(evtLen)

        // for (var i = 0; i <= evtLen; i++) {
        // alert(i > 0)
        // alert(i)
        // let letBtnContent = this.state.textAreaContent
        // if (i == 0) {
        // alert(i)
        // alert(this.state.textAreaContent)
        ...
        // this.setState({
        //     textAreaName: (this.state.textAreaContent) + evt.target.value
        //     // textAreaName1 :textAreaName + evt.target.value
        ...
        // alert(this.state.textAreaName)
        // this.state.textAreaName = evt.target.value;
