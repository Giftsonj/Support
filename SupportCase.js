...
class SupportCase extends Component {
    ...
    doSubmit(evt) {
        ...
        // let subTechButton = this.state.letMainCategory;
        // let letsubTech = {this.props.match.params.username}
        //    console.log({this.props.match.params.subTech})
        // let subTechButton = document.getElementsByClassName(sub tech 1col-md-6
        // console.log("Hiii"+this.props.subTechButton1)
        // console.log(this.state.display1)
        // document.getElementById(evt.target.id).textContent
         ...
         <AccordionItem>
            ...
            <AccordionItemPanel>
               <div className="w5-show-inline-block btnStyle">
                ...
                <div className="divTech">
                    ...
                    <div className="btnStyle">
                        ...
                        <div className="col-md-6">
                            <button type="button" id={1} className="btnTech btn_narrow" value={1} onClick={(e) => this.SubTechClick(e)}>Cisco Cat2k Switches 1</button>
                            <button type="button" id={2} className="btnTech btn_narrow" value={2} onClick={(e) => this.SubTechClick(e)}>Cisco Cat2k Switches 2</button>
                            <button type="button" id={3} className="btnTech btn_narrow" value={3} onClick={(e) => this.SubTechClick(e)}>Cisco Cat2k Switches 3</button>
                        </div>
                        <div className="col-md-6">
                            {this.state.display1 ?
                                <SubTech1></SubTech1>
                ...
                <div>
                    <br />
                    <button type="button" className="btn btn-default submit" onClick={(e) => this.doSubmit(e)}> Submit Case </button>
                </div>
            </div>
        );
    }
