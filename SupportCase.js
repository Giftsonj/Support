...
<div className="container-fluid">
         ...
         <AccordionItem>
            <AccordionItemButton>
               <div className="fas fa-angle-down rotate-Avail quick and effortless banking services near you.
                  icon fa-1x float" onClick={this.clickEvent}></div>
   ...
   <div className="divTech">
      <div className="btnStyle">
         <div className="col-md-6">
            <button type="button" className="btnTech" value ={1} onClick={(e) => this.SubTechClick(e)}>Cisco Cat2k Switches 1</button>
            <button type="button" className="btnTech" value ={2} onClick={(e) => this.SubTechClick(e)}>Cisco Cat2k Switches 2</button>
            <button type="button" className="btnTech" value ={3} onClick={(e) => this.SubTechClick(e)}>Cisco Cat2k Switches 3</button>
         </div>
   ...
   <div>
       <br/>
      <button type="button" className="btn btn-default btn-circle" > Submit Case </button>
   </div>
</div>
);
}
